...
/*
It has a Time Complexity: O(n2).
Since it uses  a nested for loop brings the time complexity to n2.
It has a Space Complexity: O(n2).
Since it uses a 2-D table is used for storing states.
 */
import java.io.*;

class PicksFromEndOfArray {
